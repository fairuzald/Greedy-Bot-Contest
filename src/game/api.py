...
class Api:
    ...
    # GET request API buat dapetin data bot
    ...
    # POST request API buat register bot
    def bots_register(
    ...
    # GET request API buat dapetin list board game
    ...
    # POST request API buat join bot kita ke board game
    ...
    # GET request API buat dapetin data board game update buat bot kita
